...
class QuizHome extends StatelessWidget {
  ...
  const QuizHome({required this.subject, required this.questions});
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('${questions.length} Questions', style: TextStyle(fontSize: 16)),
                        SizedBox(height: 6),
                        Text('Duration: ${questions.length * 30} seconds (suggested)',
                            style: TextStyle(fontSize: 14, color: Colors.grey[700])),
                        SizedBox(height: 6),
                        Text('Marks: ${questions.length * 1}', style: TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                ),
...
class QuizScreen extends StatefulWidget {
  ...
  const QuizScreen({required this.subject, required this.questions});
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Q ${currentIndex + 1} / ${widget.questions.length}',
                        style: TextStyle(color: Colors.white70)),
                    Row(children: [
                      Icon(Icons.timer, color: Colors.white54),
                      SizedBox(width: 6),
                      Text('$remaining s', style: TextStyle(color: Colors.white70))
                    ])
                  ],
                ),
                SizedBox(height: 16),
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(q.text, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                        SizedBox(height: 12),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                            side: BorderSide(color: Colors.white24), padding: EdgeInsets.symmetric(vertical: 16)),
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: Text('Show Answer', style: TextStyle(fontSize: 16)),
                      ),
                    )
                  ],
                )
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20),
                Text('Quiz Completed', style: TextStyle(color: Colors.white70, fontSize: 16)),
                SizedBox(height: 12),
                Text('$percent%', style: TextStyle(color: Colors.white, fontSize: 48, fontWeight: FontWeight.bold)),
                SizedBox(height: 12),
                Card(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 6),
                        Text('$score / $total', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                        SizedBox(height: 12),
                ...
                TextButton(
                  ...
                  child: Text('Review Answers', style: TextStyle(color: Colors.white70)),
                ),
                SizedBox(height: 18)
              ],
            ),
